...
define( 'POWERPACK_ELEMENTS_VER', '1.3.0' );
...
function pp_elements_scripts() {
    ...
    wp_register_script( 'tablesaw', POWERPACK_ELEMENTS_URL . 'assets/js/tablesaw.jquery.js', array( 'jquery' ), '3.0.3', true );
    
    wp_register_script( 'tablesaw-init', POWERPACK_ELEMENTS_URL . 'assets/js/tablesaw-init.js', array( 'jquery' ), '3.0.3', true );
    
    wp_register_script( 'pp-scripts', POWERPACK_ELEMENTS_URL . 'assets/js/pp-scripts.js', array( 'jquery' ), '1.0.0', true );
}
