...
class PP_Info_Box_Widget extends Widget_Base {
    ...
    protected function render() {
        ...
        if ( $settings['link_type'] != 'none' ) {
            ...
            if ( ! empty( $settings['link']['url'] ) ) {
                ...
                if ( $settings['link_type'] == 'box' ) {
                    ...
                    $this->add_render_attribute( 'info-box-container', 'href', $settings['link']['url'] );

                    if ( $settings['link']['is_external'] ) {
                        $this->add_render_attribute( 'info-box-container', 'target', '_blank' );
                    }

                    if ( $settings['link']['nofollow'] ) {
                        $this->add_render_attribute( 'info-box-container', 'rel', 'nofollow' );
                    }
        ...
        ?>
        <<?php echo $pp_if_html_tag . ' ' . $this->get_render_attribute_string( 'info-box-container' ); ?>>
            ...
            <div class="pp-info-box-content">
                ...
                <?php if ( $settings['link_type'] == 'button' ) { ?>
                    <div class="pp-info-box-footer">
                        <<?php echo $pp_button_html_tag. ' ' . $this->get_render_attribute_string( 'info-box-button' ); ?>>
