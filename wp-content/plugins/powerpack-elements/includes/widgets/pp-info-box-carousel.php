...
class PP_Info_Box_Carousel_Widget extends Widget_Base {
    ...
    protected function render() {
        ...
        <div <?php echo $this->get_render_attribute_string( 'info-box-carousel-wrap' ); ?>>
            <div
                 <?php echo $this->get_render_attribute_string( 'info-box-carousel' ); ?>
                 <?php
                    ...
                    if ( $item['link_type'] != 'none' ) {
                        if ( ! empty( $item['link']['url'] ) ) {
                            if ( $item['link_type'] == 'title' ) {
                                ...
                                $this->add_render_attribute( 'title-container' . $i, 'href', $item['link']['url'] );

                                if ( $item['link']['is_external'] ) {
                                    $this->add_render_attribute( 'title-container' . $i, 'target', '_blank' );
                                }

                                if ( $item['link']['nofollow'] ) {
                                    $this->add_render_attribute( 'title-container' . $i, 'rel', 'nofollow' );
                                }
                            ...
                            elseif ( $item['link_type'] == 'button' ) {
                                ...
                                $this->add_render_attribute( 'info-box-button' . $i, 'href', $item['link']['url'] );

                                if ( $item['link']['is_external'] ) {
                                    $this->add_render_attribute( 'info-box-button' . $i, 'target', '_blank' );
                                }

                                if ( $item['link']['nofollow'] ) {
                                    $this->add_render_attribute( 'info-box-button' . $i, 'rel', 'nofollow' );
                                }   
                            }
                        }
                    }
                        ...
                        <div class="pp-info-box-content">
                            ...
                            <?php if ( $item['link_type'] == 'button' ) { ?>
                                <div class="pp-info-box-footer">
                                    <<?php echo $pp_button_html_tag. ' ' . $this->get_render_attribute_string( 'info-box-button' . $i ); ?>>
