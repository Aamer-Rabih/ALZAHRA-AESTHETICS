            ...
            <colgroup>
                ...
                <col
                     ...
                     <?php if ( $col_style['table_col_bg_color'] || $col_style['table_col_width'] ) { ?>
                        ...
                        width:<?php echo $col_style['table_col_width']['size']; ?>px
                        <?php } ?>
                        "
                     <?php } ?>
                     >
        ...
        <thead>
            <tr class="pp-table-row">
                <# _.each( settings.table_headers, function( item ) { #>
                    <th id="{{ item.css_id }}" class="pp-table-cell pp-table-cell-{{ item._id }} {{ item.css_classes }} pp-table-cell-icon-{{ item.cell_icon_position }}" colspan="{{ item.col_span }}" rowspan="{{ item.row_span }}" {{ $sortable_header }}>
                        <span class="pp-table-cell-content">
                            <# if ( item.cell_icon_type != 'none' ) { #>
                                <span class="pp-table-cell-icon">
                                    <# if ( item.cell_icon_type == 'icon' && item.cell_icon != '' ) { #>
